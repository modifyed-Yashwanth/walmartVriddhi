    ...
    <div>
      ...
      <div className="md:py-10 block md:grid grid-cols-1 md:grid-cols-10 gap-7 md:gap-15 items-center justify-between">
        ...
        <div className="flex flex-col w-full justify-center my-10 lg:my-15 col-span-6">
          <p className="text-[#0053e2] mb-3">{`MSME Superpower: ${data?.acf.primary_category}`}</p>
      ...
      <div className="pb-10 font-[300] ">
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: data?.acf["cloumn-1_heading-1"] }}
        />
        <div
          className="mb-3 space-y-2 "
          dangerouslySetInnerHTML={{ __html: data?.acf["cloumn-2_heading-1"] }}
        />
        <div
          className="mb-3 space-y-2 "
          dangerouslySetInnerHTML={{ __html: data?.acf["cloumn-3_heading-1"] }}
        />
