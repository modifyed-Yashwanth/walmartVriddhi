...
function layout({ children }: ChildrenProps) {
 const url = 'https://www.walmartvriddhi.org/walmart-vriddhi-msme-summit-2025/';
  return (
    <>
    <Seo
        title="Walmart Vriddhi MSME Summit 2025: Unlocking Success with MSME Growth Program Benefits"
        ...
        url={url}
        image="/images/MSME-2025-Save-The-Date-16-05-2025.jpg"
        structuredData={{
